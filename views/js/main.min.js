...
var timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms");var frame=0;function logAverageFrame(a){for(var b=a.length,c=0,d=b-1;d>b-11;d--)c+=a[d].duration;console.log("Average scripting time to generate last 10 frames: "+c/10+"ms")}
function updatePositions(){frame++;window.performance.mark("mark_start_frame");for(var a=document.getElementsByClass(".mover"),b=0;b<a.length;b++){var c=Math.sin(document.body.scrollTop/1250+b%5);console.log(c,document.body.scrollTop/1250);a[b].style.left=a[b].basicLeft+100*c+"px"}window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");0===frame%10&&(a=window.performance.getEntriesByName("measure_frame_duration"),logAverageFrame(a))}
window.addEventListener("scroll",updatePositions);document.addEventListener("DOMContentLoaded",function(){for(var a=0;12>a;a++){var b=document.createElement("img");b.className="mover";b.src="images/pizza.png";b.style.height="100px";b.style.width="73.333px";b.basicLeft=a%8*12;b.style.top=12*Math.floor(a/8)+"px";document.getElementById("#movingPizzas1").appendChild(b)}updatePositions()});